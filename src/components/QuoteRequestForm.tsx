              ...
              >
                ...
                <div className="flex items-start justify-between mb-6">
                  <div>
                    ...
                    >
                      Isi formulir di bawah ini dan tim kami akan menghubungi
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      type="text"
                      id="fullName"
                      className="w-full px-4 py-3 rounded-lg border focus:outline-none focus:ring-2 focus:ring-primary-brown transition-all"
                      style={{
                  ...
                  <div className="flex gap-3 pt-4">
                    ...
                    <button
                      type="submit"
                      className="flex-1 btn-primary btn-icon justify-center"
                      disabled={isSubmitting}
                    >
                      {isSubmitting ? (
                        <>
